...
<x-app-layout>
    <div class="container mx-auto lg:w-full p-5">
                        ...
                        <td class="py-1 px-2 flex gap-2 w-[100px]">
                            @if (!$order->isPaid())
                                <form action="{{ route('cart.checkout-order', $order) }}"
                                    ...
                                    @csrf
                                    <button
                                        class="flex items-center px-4 py-1 text-white rounded-lg bg-orange-800 whitespace-nowrap"
                                    >
                                        <svg
                                ...
                                @else
                                <button class="flex items-center px-4 py-1 text-white text-sm font-semibold rounded-lg bg-green-600 whitespace-nowrap">
