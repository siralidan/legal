    ...
    <div class="container mx-auto lg:w-2/3 p-5">
        ...
        <div class="bg-white rounded-lg p-3">
            <table>
                ...
                <tr>
                    <td class="flex items-center px-4 py-1 text-white mt-8 text-sm font-semibold rounded-lg bg-emerald-500 whitespace-nowrap">
                        <i class='bx bx-cloud-download text-md mr-1'></i>
                        Download
                    </td>
                </tr>
                </tbody>
                ...
                <div class="flex flex-col sm:flex-row items-center  gap-4">
                    ...
                    <div class="flex flex-col justify-between">
                        ...
                        <div class="flex flex-col justify-between">
                            ...
                            <span class="text-lg font-semibold"> Ksh {{$item->unit_price}} </span>
                        </div>
                    </div>
                </div>
                <!--/ Order Item -->
            ...
            @if (!$order->isPaid())
                <form action="{{ route('cart.checkout-order', $order) }}"
                      method="POST">
                    @csrf
                    <button class="bg-orange-800 rounded-lg text-white px-2 py-1 text-md font-semibold flex items-center justify-center w-full mt-3">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 mr-1 text-md"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            stroke-width="2"
